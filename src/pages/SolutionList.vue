        ...
        <el-row>
            ...
            <el-col :span="20">
                <div>
                    <h1>题解</h1>
                    <div id="addbutton">
                        <el-button type="primary" @click="AddSolution" v-show="addbuttonshow" :disabled="addbuttondisabled">写题解</el-button>
                    </div>
                </div>
                <el-card v-for="(data,index) in serverdata.array" id="solutioncard">
                    <el-row>
                        <el-col :span="2">
                            <el-avatar :size="70" :src="data.User[0].Avatar"/>
                        </el-col>
                        <el-col :span="22">
                            <router-link :to="{name:'Solution',query:{SolutionId:data._id}}">
                                <span id="solutiontitle">{{ data.Title }}</span>
                            </router-link>
                            <br> 
                            <br>
